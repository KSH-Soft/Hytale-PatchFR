...
### ⚙️ Installation Automatique + AutoUpdate
...
1. **Fermez Hytale** s’il est en cours d’exécution
2. **Téléchargez** le script [`HytalePatchFR_Win_ByKSH-Soft.bat`](https://github.com/KSH-Soft/Hytale-PatchFR/releases/download/v0.3/HytalePatchFR_Win_ByKSH-Soft.bat)
